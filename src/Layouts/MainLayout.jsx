        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col transition-colors duration-300">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex-shrink-0 flex items-center">
                            <Link to="/fotografias" className="flex items-center gap-2">
                        ...
                        <nav className="hidden md:flex items-center space-x-6">
                            <Link to="/fotografias" className="flex items-center text-gray-600 hover:text-indigo-500 dark:text-gray-300 dark:hover:text-indigo-400 px-3 py-2 text-sm font-medium transition-colors">
                            ...
                            <Link to="/fotografias/create" className="flex items-center text-gray-600 hover:text-indigo-500 dark:text-gray-300 dark:hover:text-indigo-400 px-3 py-2 text-sm font-medium transition-colors">
                            ...
                            <Link to="/desafios" className="flex items-center text-gray-600 hover:text-indigo-500 dark:text-gray-300 dark:hover:text-indigo-400 px-3 py-2 text-sm font-medium transition-colors">
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                    <Link to="/grupos" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Mis grupos</Link>
                                    <Link to="/grupos/create" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Crear grupo</Link>
                                    <Link to="/grupos/unirse" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Unirse a grupo</Link>
                                </div>
                            </div>

                            {user?.rol === 'admin' && (
                                <Link to="/admin" className="flex items-center text-yellow-600 hover:text-yellow-500 px-3 py-2 text-sm font-bold transition-colors">
                        ...
                        <div className="flex items-center space-x-4">
                            {user ? (
                                <div className="relative">
                                    ...
                                    {showProfileMenu && (
                                        <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 z-50 animate-fade-in">
                                            <Link to="/profile" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Mi perfil</Link>
                                            <Link to="/mis-fotografias" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Mis publicaciones</Link>
                                            <Link to="/mis-desafios" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Mis desafios</Link>
                                            <Link to="/grupos" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Mis grupos</Link>
                                ...
                                <div className="space-x-4">
                                    ...
                                    <Link to="/register" className="text-sm font-medium bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-full shadow-md hover:shadow-lg transition-all hover-lift">
                                        Registrarse
                                    </Link>
                                </div>
                            )}
            ...
            <footer className="hidden md:block glass border-t border-gray-200 dark:border-gray-800 py-6 mt-auto">
                <div className="max-w-7xl mx-auto px-4 text-center text-sm text-gray-500 dark:text-gray-400">
                    &copy; {new Date().getFullYear()} Enfoca. Todos los derechos reservados. Creado con MUCHO cariño por <a href="https://github.com/juanesj2" target="_blank" rel="noreferrer">Juanes😎</a>
                </div>
            </footer>
            ...
            >
                ...
                <div className="flex items-center justify-around h-16 px-2">
                    ...
                    <Link to="/fotografias" className={`flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl transition-colors ${isActive('/fotografias') && !isActive('/fotografias/create') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400'}`}>
                    ...
                    <Link to="/desafios" className={`flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl transition-colors ${isActive('/desafios') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400'}`}>
                    ...
                    <Link to="/fotografias/create" className="flex flex-col items-center gap-0.5 px-2 py-1 -mt-4">
                    ...
                    <Link to="/grupos" className={`flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl transition-colors ${isActive('/grupos') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400'}`}>
                    ...
                    {user ? (
                        <Link to="/profile" className={`flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl transition-colors ${isActive('/profile') || isActive('/mis-') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400'}`}>
                        ...
                        <Link to="/login" className="flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl text-gray-500 dark:text-gray-400 transition-colors">
                            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
