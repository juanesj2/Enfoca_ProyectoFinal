...
export default function Register() {
    useEffect(() => {
        document.title = "Registro - Enfoca";
    }, []);
            ...
            <div className="w-full max-w-md animate-fade-in-up">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm">
                        Únete a la comunidad de fotógrafos
                    </p>
                </div>
                ...
                <div className="glass-panel bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-white/50 dark:border-gray-800 rounded-3xl shadow-2xl p-8">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Crea tu cuenta</h1>
                    <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">Completa tus datos para empezar</p>
