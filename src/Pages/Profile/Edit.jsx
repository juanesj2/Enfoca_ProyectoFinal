...
export default function Edit() {
    ...
    useEffect(() => {
        document.title = "Editar Perfil - Enfoca";
    }, []);
    ...
    const [pwdSuccessful, setPwdSuccessful] = useState(false);
    ...
    const updatePassword = (e) => {
        ...
        putPassword('/usuario', {
            onSuccess: () => {
                ...
                setTimeout(() => setPwdSuccessful(false), 3000);
            },
            onError: (errors) => {
                if (errors.password) {
    ...
    return (
        <MainLayout>
            <div className="max-w-4xl mx-auto py-10 space-y-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-10 text-center animate-fade-in-up">
                    ...
                    <p className="mt-2 text-gray-500 dark:text-gray-400">
                        Administra tu información personal, cambia tu contraseña o elimina tu cuenta.
                    </p>
                </div>

                {/* Formulario 1: Información Personal */}
                <section className="glass-panel p-8 border border-gray-200 dark:border-gray-800 rounded-3xl shadow-sm animate-fade-in-up" style={{animationDelay: '0.1s'}}>
                    ...
                    <form onSubmit={updateProfile} className="space-y-6 max-w-xl">
                        <div>
                            <label htmlFor="name" className="block text-sm font-semibold text-gray-700 dark:text-gray-300">Nombre</label>
                            <input
                                id="name"
                        ...
                        <div>
                            <label htmlFor="email" className="block text-sm font-semibold text-gray-700 dark:text-gray-300">Correo Electrónico</label>
                            <input
                                id="email"
                                type="email"
                ...
                <section className="glass-panel p-8 border border-gray-200 dark:border-gray-800 rounded-3xl shadow-sm animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                    <header className="mb-6">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                    ...
                    <form onSubmit={updatePassword} className="space-y-6 max-w-xl">
                        <div>
                            <label htmlFor="current_password" className="block text-sm font-semibold text-gray-700 dark:text-gray-300">Contraseña Actual</label>
                            <input
                                id="current_password"
                        ...
                        <div>
                            <label htmlFor="password" className="block text-sm font-semibold text-gray-700 dark:text-gray-300">Nueva Contraseña</label>
                            <input
                                id="password"
                                ref={passwordInput}
                        ...
                        <div>
                            <label htmlFor="password_confirmation" className="block text-sm font-semibold text-gray-700 dark:text-gray-300">Confirmar Contraseña</label>
                            <input
